...
export default class App extends React.Component {
  ...
  setupWorld = () => {
    ...
    let floor1 = Matter.Bodies.rectangle(Constants.MAX_WIDTH / 2, Constants.MAX_HEIGHT - 100, Constants.MAX_WIDTH + 4, 50, 
      { isStatic: true });

    let floor2 = Matter.Bodies.rectangle(Constants.MAX_WIDTH + (Constants.MAX_WIDTH / 2),Constants.MAX_HEIGHT - 100,Constants.MAX_WIDTH + 4,50,
      { isStatic: true }
  );
